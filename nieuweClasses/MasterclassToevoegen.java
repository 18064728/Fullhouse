...
public class MasterclassToevoegen extends JDialog {
    ...
    //COMPONENTS
    protected JComboBox<Object> dag;
    protected JComboBox<Object> maand;
    protected JComboBox<Object> jaar;
    protected int datumDag;
    protected int datumMaand;
    protected int datumJaar;
    JComboBox<String>locaties;


    protected JSpinner begintijdMin;
    protected JSpinner begintijdUur;
    protected JSpinner eindtijdMin;
    protected JSpinner eindtijdUur;
    protected JSpinner kostensp;
    protected JSpinner min_ratingSp;

    protected JComboBox<Object> pokerspelersCb;

    protected JButton voegToeBtn;
    protected JButton terugBtn;

    MasterclassToevoegen() {
        ...
        class VoegToe implements ActionListener {
            public void actionPerformed(ActionEvent e) {
                ...
                datumDag = dag.getSelectedIndex() + 1;
                datumMaand = maand.getSelectedIndex() + 1;
                datumJaar = jaar.getSelectedIndex() + 2019;
                datum = datumJaar + "-" + datumMaand + "-" + datumDag;
