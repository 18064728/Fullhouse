 ...
 */
class GastToevoegen extends JDialog {
    ...
    //COMPONENTS
    JFormattedTextField naamTxt;
    JRadioButton man;
    JRadioButton vrouw;
    JComboBox<Object> dayList;
    JComboBox<Object> monthList;
    JComboBox<Object> yearList;
    JFormattedTextField adresTxt;
    JFormattedTextField postcodeTxt;
    JFormattedTextField woonplaatsTxt;
    JFormattedTextField telefoonnummerTxt;
    JFormattedTextField emailTxt;
    JButton terugBtn1;
    JButton voegToeBtn;
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try { //adds guest to database
                    ...
                    if (isValidInput()) { //adds guest to the database if the input is valid
                        ...
                        ps.executeUpdate();
                        JOptionPane.showMessageDialog(null, "gast is toegevoegd aan de database");
    ...
    private Boolean isValidInput() { //checks if input is valid
        ...
        if (telefoonnummer.length() >= 12) {
            telefoonnummerTxt.setText("Telefoonnummer te lang");
            validInput = false;
        }
        if (email.equals("")) {
