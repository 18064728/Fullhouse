...
public class Scherm extends JFrame {
    ...
    private JButton toernooiWinnaar;
    private JButton toernooiWinnaarToevoegen;
    ...
    private JButton bekendePokerSpelerToevoegen;
    private JButton bekendePokerSpelerControleren;
    ...
    private JButton masterClassInschrijvingControleren;
    ...
    Scherm(){
        ...
        toernooiButton = new JButton( new AbstractAction("Toernooi") {
            ...
            public void actionPerformed( ActionEvent e ) {
                ...
                toernooiWinnaar.setVisible(true);
                toernooiWinnaarToevoegen.setVisible(true);
            }
        });
        ...
        masterClassButton = new JButton( new AbstractAction("Master Class") {
            ...
            public void actionPerformed( ActionEvent e ) {
                ...
                bekendePokerSpelerControleren.setVisible(true);
                bekendePokerSpelerToevoegen.setVisible(true);
            }
        });
        ...
        inschrijvingButton = new JButton(new AbstractAction("Inschrijven") {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                masterClassInschrijvingControleren.setVisible(true);
            }
        });
        ...
        toernooiTerug = new JButton( new AbstractAction("Terug") {
            ...
            public void actionPerformed( ActionEvent e ) {
                ...
                toernooiWinnaar.setVisible(false);
                toernooiWinnaarToevoegen.setVisible(false);
        ...
        toernooiWinnaar = new JButton(new AbstractAction("Toernooi winnaars") {
            @Override
            public void actionPerformed(ActionEvent e) {
                JDialog d = new WinnaarControleren();
            }
        });
        toernooiWinnaar.setBounds(175, 150, 150, 50);
        toernooiWinnaar.setVisible(false);
        panel.add(toernooiWinnaar);

        toernooiWinnaarToevoegen = new JButton(new AbstractAction("Winnaars toevoegen") {
            @Override
            public void actionPerformed(ActionEvent e) {
                JDialog d = new WinnaarToevoegen();
            }
        });
        toernooiWinnaarToevoegen.setBounds(15, 150, 150, 50);
        toernooiWinnaarToevoegen.setVisible(false);
        panel.add(toernooiWinnaarToevoegen);
        ...
        masterClassTerug = new JButton( new AbstractAction("Terug") {
            ...
            public void actionPerformed( ActionEvent e ) {
                ...
                bekendePokerSpelerControleren.setVisible(false);
                bekendePokerSpelerToevoegen.setVisible(false);
        ...
        masterClasscontroleren = new JButton( new AbstractAction("Masterclass controleren") {
            @Override
            public void actionPerformed( ActionEvent e ) {
                JDialog d = new MasterclassControleren();
            }
        });
        ...
        bekendePokerSpelerToevoegen = new JButton(new AbstractAction("<html>Bekende Pokerspeler<br> toevoegen</html>") {
            @Override
            public void actionPerformed(ActionEvent e) { JDialog d = new BekendePokerspelerToevoegen(); }
        });
        bekendePokerSpelerToevoegen.setBounds(175, 150, 150, 50);
        bekendePokerSpelerToevoegen.setVisible(false);
        panel.add(bekendePokerSpelerToevoegen);

        bekendePokerSpelerControleren = new JButton(new AbstractAction("<html>Bekende Pokerspelers<br> controleren</html>") {
            @Override
            public void actionPerformed(ActionEvent e) { JDialog d = new BekendePokerspelerControleren(); }
        });
        bekendePokerSpelerControleren.setBounds(15, 150, 150, 50);
        bekendePokerSpelerControleren.setVisible(false);
        panel.add(bekendePokerSpelerControleren);
        ...
        inschrijvingButtonTerug = new JButton( new AbstractAction("Terug") {
            ...
            public void actionPerformed( ActionEvent e ) {
                ...
                masterClassInschrijvingControleren.setVisible(false);
        ...
        toernooInschrijvingControleren.setBounds(175,150,150,50);
        toernooInschrijvingControleren.setVisible(false);
        panel.add(toernooInschrijvingControleren);

        masterClassInschrijvingControleren = new JButton(new AbstractAction("<html>Masterclass inschrijving<br> controleren</html>") {
            @Override
            public void actionPerformed(ActionEvent e) {
                
            }
        });
        masterClassInschrijvingControleren.setBounds(15, 150, 150, 50);
        masterClassInschrijvingControleren.setVisible(false);
        panel.add(masterClassInschrijvingControleren);
    }
}